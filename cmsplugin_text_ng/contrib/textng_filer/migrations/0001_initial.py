...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TextNGVariableFilerImage'
        db.create_table('textng_filer_textngvariablefilerimage', (
            ...
            ('value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal('textng_filer', ['TextNGVariableFilerImage'])

        # Adding unique constraint on 'TextNGVariableFilerImage', fields ['text_ng', 'label']
        db.create_unique('textng_filer_textngvariablefilerimage', ['text_ng_id', 'label'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TextNGVariableFilerImage', fields ['text_ng', 'label']
        db.delete_unique('textng_filer_textngvariablefilerimage', ['text_ng_id', 'label'])

        # Deleting model 'TextNGVariableFilerImage'
        db.delete_table('textng_filer_textngvariablefilerimage')
    ...
    models = {
        ...
        'textng_filer.textngvariablefilerimage': {
            'Meta': {'unique_together': "(('text_ng', 'label'),)", 'object_name': 'TextNGVariableFilerImage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'text_ng': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['cmsplugin_text_ng.TextNG']"}),
            'value': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['textng_filer']
